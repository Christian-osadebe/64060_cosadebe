...
head(df_sub,1)
```
The probability value from the model output for P(Loan = 1 | CC = 1, Online = 1),
is the same as the value obtained using the Naive Bayes probability formula in part
E. 
